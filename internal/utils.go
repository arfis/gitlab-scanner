...
func GetProjects(cfg Configuration) []Project {
...
func GetGoMod(cfg Configuration, projectID int, projectName string, ref ...string) []byte {
...
func ListRepoFiles(cfg Configuration, projectID int, ref string) []File {
	perPage := 100
	page := 1
	var out []File
...
func GetRawFileBytes(cfg Configuration, projectID int, filePath, ref string) []byte {
