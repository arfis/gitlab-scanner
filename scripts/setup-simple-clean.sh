...
# Setup simple clean DNS for prosoft.gitscanner
set -e

echo "🌐 Setting up simple clean DNS for prosoft.gitscanner..."

# Use localhost with port 8080 (avoids port 80 conflicts)
CLEAN_IP="127.0.0.1"
...
echo ""
echo "🎉 Simple clean DNS setup complete!"
echo ""
echo "📋 Next steps:"
echo "1. Start the application: make docker-simple-clean"
echo "2. Visit: http://prosoft.gitscanner:8080"
echo "3. No conflicts with port 80!"
echo ""
...
echo "   ✅ No port 80 conflicts"
echo "   ✅ Uses port 8080 (safe)"
